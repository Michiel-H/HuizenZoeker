"""Collector for VVA Amsterdam (particulier woningaanbod) listings."""
...
class VVAAmsterdamCollector(BaseCollector):
    SOURCE_NAME = "VVA Amsterdam"
    BASE_URL = "https://www.vva-amsterdam.nl"
        ...
        try:
            ...
            for item in items:
                try:
                    ...
                    logger.debug(f"[VVA] Parse error: {e}")
        except Exception as e:
            logger.error(f"[VVA] Fetch error: {e}")
        return listings
